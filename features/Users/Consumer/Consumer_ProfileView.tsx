...
const Consumer_ProfileView: React.FC = () => {
  ...
  // Mock posts data - filter to show only 'Selling' posts to consumers
          ...
          <View style={styles.profileHeader}>
            ...
            <View style={styles.profileInfo}>
              ...
              <View style={styles.ratingContainer}>
                {renderStarRating(Math.floor(storeOwner.starRating || 0))}
                <Text style={styles.ratingText}>
                  {storeOwner.starRating} ({storeOwner.totalReviews})
                </Text>
              </View>
          ...
          <View style={styles.commentsModal}>
            ...
            <ScrollView style={styles.commentsContainer}>
              <View style={styles.commentItem}>
                ...
                <Text style={styles.commentText}>Fresh vegetables and fruits available! Best prices in town. Visit our store for quality pro...</Text>
