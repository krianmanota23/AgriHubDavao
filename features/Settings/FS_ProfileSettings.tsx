...
interface FSProfileSettingsProps {
  navigation: any;
  route: any;
}

const FS_ProfileSettings: React.FC<FSProfileSettingsProps> = ({ navigation, route }) => {
  ...
  const handleImageSelection = (option: string) => {
    ...
    if (option === 'remove') {
      ...
      const placeholderImage = 'https://via.placeholder.com/150/4CAF50/FFFFFF?text=👤';
  ...
  const handleSaveChanges = async () => {
    try {
      ...
      const requiredFields: (keyof FarmerFormData)[] = ['firstName', 'lastName', 'userName', 'email', 'phoneNumber', 'farmLocation'];
          ...
          <View style={styles.content}>
            ...
            <View style={styles.profileSection}>
              ...
              <View style={styles.roleContainer}>
                <Text style={styles.roleText}>Farmer/Supplier</Text>
              </View>
            </View>
            ...
            <View style={styles.inputContainer}>
              ...
              <TextInput
                style={styles.input}
                placeholder="Enter your farm address/location"
              ...
              <Text style={styles.locationHint}>
                📍 This will help customers find your farm
              </Text>
            </View>
...
export default FS_ProfileSettings;
