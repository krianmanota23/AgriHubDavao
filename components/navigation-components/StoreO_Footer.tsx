...
const StoreO_Footer: React.FC<StoreOFooterProps> = ({ 
  activeTab, 
  setActiveTab, 
  navigation, 
  currentUser, 
  ...
  const handleNavigation = (tab: string) => {
    ...
    if (tab === 'Home') {
      const isOnHomeScreen = currentScreen === 'StoreOwnerHome';
      ...
      navigation.navigate('MessagesScreen', { userRole: 'Store Owner' });
    } else if (tab === 'Notifications' && navigation) {
      navigation.navigate('NotificationsScreen', { userRole: 'Store Owner' });
    } else if (tab === 'Friends' && navigation) {
      navigation.navigate('FriendsScreen', { userRole: 'Store Owner' });
    }
  };
